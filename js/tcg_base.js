...
tcg_base_system = {
	...
	caul_address: "0xAa94586d037e19e02D9868Fb8714cD061b838c01", // old > "0x1360398fFD6E9148Bd3FEc2910afa0660DFcE4cB",
...
function updateCardDisplay(level) {
    ...
    // Reset all slots to show the "none" image
    ...
    selectedCards.forEach(card => {
        if (card.burned) {
            $(`.conjure_cards_card[data-card-slot="${card.slot}"]`).css({
